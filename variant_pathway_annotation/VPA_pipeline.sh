...
python 6_parse_IGAP_annotation.py
...
python 9_parse_LITERATURE_annotation.py
...
#GO is a sql database, the script for the download is in 11_gene_ontology_sql
#all the downloaded files are stored in gene_ontology folder
#for go in gene_ontology/*all_genes*; do python 12_parse_GENE-ONTOLOGY_annotation.py $go; done
...
python 16_parse_DAVID_annotation.py
